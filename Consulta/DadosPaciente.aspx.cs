...
public partial class Consulta_DadosPaciente : System.Web.UI.Page
{
	...
	protected void Button1_Click(object sender, EventArgs e)
	{
		...
		using (SqlConnection cnn = new SqlConnection(ConfigurationManager.ConnectionStrings["SqlServices"].ToString()))
		{
			...
			" marcada, consulta,dtCon, hrCon, telefone, obs, usuario, impr) VALUES (@rh,@data,@especialidade, @solicitante, " +
			" @retorno, @regulacao, @qtdExames,@situacao, @marcada, @consulta,@dtCon,@hrCon, @telefone, @obs, @usuario, @impr)";
